...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">CAFEKU</span>
      </a>
  ...
  <div class="mt-5 mx-5">
<h3 class="h3 text-center mb-3"> Koleksi Menu </h3>
<div class="row">
    @foreach ($data as $item)
    <div class="col-3">
        <div class="card text-center">
            <img src="{{asset('storage/' .$item->foto)}}" alt="" class="card-img-top" width="50px" >
            <div class="card-body">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
          &copy; <strong><span>CAFEKU</span></strong>. By Fauziyah Amini
        </div>
        <div class="credits">
          ...
          Alamat <a href="https://bootstrapmade.com/">Jl. Tirtirahayu Gang 11</a>
        </div>
      </footer><!-- End Footer -->
